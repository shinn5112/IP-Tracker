...
if oldSettings is False:  # lets the user know that no previous settings were found
    print("No previous settings were found, please select option 1.\n")
else:
    print("A settings file was found, you can either edit the file or start fresh by configuring it. \n")
...
while not done:
    ...
    # End program
        ...
        if settingWrite is True:  # if the settings were written, do this
            ...
            print("Your settings were never saved, to save your settings please write them before closing the program.")
